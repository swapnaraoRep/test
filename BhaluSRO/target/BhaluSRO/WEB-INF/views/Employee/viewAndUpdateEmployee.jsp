...
<td><form:errors path="department_id" cssClass="error"/></td>
 ...
 <tr>
<td>
<form:select path="department_id" cssClass="focus1">


 <c:forEach items="${DepartmentList}" var="dept">

<form:options items="${dept.getDepartmentId()}"/>
 </c:forEach>
</form:select> 
</td>
...
<%-- <c:forEach items="${DepartmentList}" var="employee">
<tr>
			<td  width="80">${employee.DepartmentId}</td>
				<td width="120">${employee.DepartmentName}</td>
